...
export function AboutSection() {
  return (
    <section id="concept" className="section-padding relative bg-wafa-very-dark z-10">
          ...
          {[
            ...
            <SectionWrapper key={i} delay={i * 0.1}>
              <GlassCard hoverable className="h-full flex flex-col items-center text-center">
                ...
                <h3 className="font-montserrat font-bold text-xl text-white mb-4">{feature.title}</h3>
                <p className="font-montserrat text-white/60 text-sm leading-relaxed">{feature.desc}</p>
              </GlassCard>
            </SectionWrapper>
          ))}
        </div>
